...
const BottomText = () => {
  return (
    <div className="bottom__text">
      ...
      <p className="text">
        © 2022 VMware, Inc. or its affiliates. Terms of Use • Privacy •
        Trademark Guidelines • Your California Privacy Rights • Сookie
      </p>
      <p className="text">
        ...
        Foundation in the United States and/or other countries. Java™, Java™ SE,
        Java™ EE, and OpenJDK™ are trademarks of Oracle and/or its affiliates.
        ...
        Linus Torvalds in the United States and other countries. Windows® and
        Microsoft® Azure are registered trademarks of Microsoft Corporation.
        “AWS” and “Amazon Web Services” are trademarks or registered trademarks
        of Amazon.com Inc. or its affiliates. All other trademarks and
        copyrights are property of their respective owners and are only
        mentioned for informative purposes. Other names may be trademarks of
    ...
    <div className="social__block">
      <a href="#" className="social">
        <svg
          ...
          viewBox="0 0 40 40"
        >
          <circle className="cls-1" cx="20" cy="20" r="20"></circle>
          <path
            className="cls-2"
      ...
      <a href="#" className="social">
        <svg
          ...
          viewBox="0 0 75.93 75.93"
        >
          <circle className="cls-1" cx="37.97" cy="37.97" r="37.97"></circle>
          <path
            id="Twitter-2"
            data-name="Twitter"
            className="cls-2"
